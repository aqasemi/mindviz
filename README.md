...
Recommendation: [BaiduNetdisk](https://pan.baidu.com/s/1ZZWBrrp2Ly2ZOBHKT0fmTA?pwd=9j22), things.zip, things-eeg.zip, things-meg.zip is necessary, other files are optional. 
